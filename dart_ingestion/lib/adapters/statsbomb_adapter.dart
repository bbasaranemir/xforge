...
class StatsBombAdapter implements DataAdapter {
  ...
  UnifiedEvent _mapEvent(Map<String, dynamic> e, int matchId, int competitionId) {
    ...
    return UnifiedEvent(
      ...
      locationX: (location != null && location.length > 0) ? (location[0] as num).toDouble() : null,
      locationY: (location != null && location.length > 1) ? (location[1] as num).toDouble() : null,
      endLocationX: (endLoc != null && endLoc.length > 0) ? (endLoc[0] as num).toDouble() : null,
      endLocationY: (endLoc != null && endLoc.length > 1) ? (endLoc[1] as num).toDouble() : null,
      outcome: outcome,
